...
class ListItemTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        listItem = ["rain", "wind", "water"]

    }
    
    func createHederView (){
        
        let _headerView = UIView()
        _headerView.frame = CGRectMake( 0, 0, self.tableView.frame.width, 40)
